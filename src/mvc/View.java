...
public class View {
	...
	public View(Stage stage, Controller controller) {
		...
		// // so far it is MainMenuScene <-> GardenInfoScene <-> TutorialScene <->
		// DrawScene
		//
		// theStage = stage;
		...
		//
		// /**
		// * Changes to the main menu/title screen with buttons to begin the
		// application.
		...
		//
		// /**
		// * Changes to the tutorial screen when a small button at the top of the page
		// is
		...
		// * Roads, Grass, Shade, Streams, Woods, and extra objects in the terrain.
		// There
		// * will be a side bar which includes all of the types of terrain, and a tool
		// to
		...
		//
		// /**
		// * Changes to the garden screen where the user can drag and drop plants into
		// the
		...
		// return drawScene;
		// }
		// }some type of Pane so we don't have to manually put the button
		// translations for the Scenes in the View package
